          ...
          <div className="font-bold border-1 border-gray-100 p-3 w-[30rem] rounded-lg shadow-md flex gap-2  items-center justify-between">
            ...
            <form>
              {(display || currentStep === 0) && (
                <>
                  <label htmlFor="Select-Master-Catagory">
                    select Master Catagory
                  </label>
                  <div>
                    <select
        ...
        <button className='text-black p-3 rounded-lg shadow-lg'>Save</button>
              ...
              {currentStep === 1 && (
                <>
                  ...
                  />
                  <label htmlFor="price-validation">{steps[1].fields[2]}</label>
                  <input
                    type="text"
                    name={steps[1].name}
                    id={steps[1].id}
                    placeholder={steps[1].fields[2]}
                  />
                </>
              )}
              {currentStep === 2 && (
